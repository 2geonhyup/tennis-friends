...
import 'package:tennis_friends_demo/screens/register_login_screens/name_setting_screen.dart';
          ...
          child: Padding(
            ...
            child: Column(
                ...
                children: [
                  ...
                  RoundedButton(
                    colour:
                        Provider.of<UserData>(context, listen: false).allFilled
                            ? Color(0xff27AC84)
                            : Colors.black45,
                    title: '프로필 완성하기',
                    onPressed: () {
                      if (Provider.of<UserData>(context, listen: false)
                              .allFilled ==
                          false) return;
                      Navigator.pushNamed(context, NameSettingScreen.id);
                    },
                  ),
                ]),
          ),
